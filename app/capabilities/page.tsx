        ...
        {services.map((svc, i) => (
          <div key={svc.index} className={i % 2 === 1 ? "bg-[#F1F1F1]" : "bg-white"}>
            <div className="max-w-6xl mx-auto px-6 py-16">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-[#112E51] mb-5">
                {svc.title}
              </h2>
      ...
      <div className="bg-[#F1F1F1] border-t border-[#D6D7D9] px-6 py-10">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <a
            ...
            className="inline-block px-6 py-3 bg-[#112E51] text-white text-sm font-semibold rounded-sm hover:bg-[#1a3f6f] transition-colors w-fit shrink-0"
          >
