...
const sections = [
  ...
  },
  {
    ...
    body: "All public RFP and pricing data is processed in isolated, stateless local environments. Processing pipelines are initialized per-engagement and do not persist client data across sessions. We do not use Prime data — or any client-furnished acquisition documents — to train, fine-tune, or evaluate commercial LLMs or any third-party model. Model inference occurs on locally-deployed, air-gap-capable infrastructure.",
    properties: [
      { label: "Processing Environment", value: "Isolated / Stateless Local" },
      ...
      { label: "Third-Party Cloud AI APIs", value: "Not used during processing" },
